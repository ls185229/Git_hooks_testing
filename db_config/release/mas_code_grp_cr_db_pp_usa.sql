set linesize 1000
set pagesize 500
--Change the institution_id & execute for all the USAadian institution between 129 and 135

insert into MAS_CODE_GRP
    (INSTITUTION_ID, MAS_CODE_GRP_ID, QUALIFY_MAS_CODE, MAS_CODE)
select
    '101' as institution_id ,
