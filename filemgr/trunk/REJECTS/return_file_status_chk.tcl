...
# $Id: return_file_status_chk.tcl 3597 2015-12-01 21:27:00Z bjones $
...
set sql1 "select * from in_file_log where incoming_dt like '$e_date%' and file_type in ('41','55','56')"
puts $sql1
orasql $get $sql1
...
exec echo "$mbody_c $sysinfo $mbody\n\n$sms" | mailx -r $mailfromlist -s "$msubj_c" assist@jetpay.com clearing@jetpay.com
