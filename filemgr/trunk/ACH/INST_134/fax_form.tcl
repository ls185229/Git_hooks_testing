...
# $Id: fax_form.tcl 4242 2017-07-25 14:08:04Z lmendis $
...
proc file_header_rec {line_in} {
    ...
    #set ORIGINATOR_NAME [string range $line_in 10 23]
...
proc detail_rec {line_in}  {
    ...
    set EFFECTIVE_DATE "[string range $line_in 37 42]"
    set tran_amount [unoct [string range $line_in 27 36]]
    switch [string range $line_in 0 0] {
        "C" { set CREDIT_TOTAL [expr $CREDIT_TOTAL + $tran_amount]
               incr CREDIT_COUNT}
        "D" { set DEBIT_TOTAL [expr $DEBIT_TOTAL + $tran_amount]
               incr DEBIT_COUNT}
...
if {$file_type == "62"} {
    ...
    puts " People’s Trust – PTC Direct US"
    puts " ACH TRANSMITTAL LETTER"
    puts " "
    puts " "
    puts " Fax To: (xxx) xxx-xxxx or (xxx) xxx-xxxx"
    puts " "
    ...
    puts " "
    puts " "
    puts " In case of transmissions questions: "
    puts "    Signature's Phone Number: 1-800-834-4405"
    puts "    Institution: $inst_id"
    puts " "

} else {

    puts "   Originator Name: NCR PS LLC"
