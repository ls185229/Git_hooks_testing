...
################################################################################
# $Id: esquire_fax_form.tcl 4242 2017-07-25 14:08:04Z lmendis $
# $Rev: 4242 $
################################################################################
#
# File Name:  esquire_fax_form.tcl
#
# Description:  This program parses the contents of the Esquire Bank ACH file
#               for faxing.
#
...
#****** Main Code ******
if {$argc != 1} {
    error "Usage: esquire_fax_form.tcl filename"
}
...
#puts "ORIGINATOR_NAME: $ORIGINATOR_NAME"
