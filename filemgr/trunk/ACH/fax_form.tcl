...
# $Id: fax_form.tcl 4234 2017-07-05 21:13:28Z skumar $
...
proc convert_amount {string_in} {
    ...
    set conv_amt "[string range $string_in 0 10]$converted_digit"
    ##    puts "conv_amt is $conv_amt"
    set amount [expr [unoct $conv_amt] / 100.0 * $multiplier]
    return $amount
};# end convert_amount
