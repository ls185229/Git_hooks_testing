...
################################################################################
# $Id: get_ach_file.tcl 4050 2017-02-03 17:15:20Z bjones $
# $Rev: 4050 $
################################################################################
#
...
#set locpath "\clearing\filemgr\ACH\INST_130"
...
if {$argc == 3} {
    ...
    if {$filelist == ""} {
      ...
      set loc_pth ""
      set loc_pth $env(PWD)
      exec create_bmo_eft_file.tcl $fname2  >> $logfile
    }
    ...
    catch {set filelist2 [glob DEFT-RPTCAD*]} result
