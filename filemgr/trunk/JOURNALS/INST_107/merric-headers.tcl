...
set fdate [clock format [clock scan "-8 day"] -format %b-%y]
set date [clock format [clock scan "-8 day"] -format %d-%b-%y]
set filedate [clock format [clock scan "-8 day"] -format %Y%m%d]
set name_date_month [clock format [clock scan "-8 day"] -format %B]
set name_date_year [clock format [clock scan "-8 day"] -format %Y]
...
set query_string "select unique entity_id from mas_trans_log where DATE_TO_SETTLE like '%$fdate' and institution_id = '101' and ENTITY_LEVEL = '70'"
puts $query_string
