...
set cur_file_name "./107.REPORT.IE.$CUR_JULIAN_DATEX.$filedate.001.csv"
set file_name "107.REPORT.IE.$CUR_JULIAN_DATEX.$filedate.001.csv"
...
set upper_date [string toupper $upper_date]
  set year_date [clock format [clock scan "-[expr $days_back * 1] day"] -format %y]
  switch -- $value {
    1 { set a "(activity_date_time like '%JAN-$year_date' or activity_date_time like '%FEB-$year_date' or activity_date_time like '%MAR-$year_date') and activity_date_time <= '$upper_date'"}
    2 { set a "(activity_date_time like '%APR-$year_date' or activity_date_time like '%MAY-$year_date' or activity_date_time like '%JUN-$year_date')  and activity_date_time <= '$upper_date'"}
    3 { set a "(activity_date_time like '%JUL-$year_date' or activity_date_time like '%AUG-$year_date' or activity_date_time like '%SEP-$year_date') and activity_date_time <= '$upper_date'"}
    4 { set a "(activity_date_time like '%OCT-$year_date' or activity_date_time like '%NOV-$year_date' or activity_date_time like '%DEC-$year_date') and activity_date_time <= '$upper_date'"}
  }
...
proc section_header {value} {
 ...
 global upper_date year_date name_date_month name_date_year month_date name_date collist1 rightnow cur_local_time CUR_SET_TIME cur_file

set Month_Count 1
set Quarter_Count 1
set Year_Count 1
puts "VOLUME"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and tid like '0100030051%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Volume $t(AMOUNT)
  set Month_Count $t(COUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '0100030051%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Volume $t(AMOUNT)
  set Quarter_Count $t(COUNT)
}

set date_query ""
set date_query "activity_date_time like '%$name_date_year' and activity_date_time <= '$upper_date'"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '0100030051%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Volume $t(AMOUNT)
  set Year_Count $t(COUNT)
}

puts "REFUND"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'D' and $value and tid like '0100030051%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Refund_Volume $t(AMOUNT)
  set Month_Refund_Count $t(COUNT)
}
 
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'D' and $value and tid like '0100030051%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Refund_Volume $t(AMOUNT)
  set Quarter_Refund_Count $t(COUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Refund_Volume $t(AMOUNT)
  set Year_Refund_Count $t(COUNT)
}
...
puts "DISCOUNT"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and (tid like '010004%' or tid like '01000507%')  and institution_id = '107' and settl_flag = 'Y'"
puts $query_string
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Discount_Volume $t(AMOUNT)
  set Month_Discount_Count $t(COUNT)
}
 
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'D' and $value and (tid like '010004%' or tid like '01000507%') and institution_id = '107' and settl_flag = 'Y'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and (tid like '010004%' or tid like '01000507%') and institution_id = '107' and settl_flag = 'Y'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Discount_Volume $t(AMOUNT)
  set Quarter_Discount_Count $t(COUNT)
}

set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'D' and $value and (tid like '010004%' or tid like '01000507%') and institution_id = '107' and settl_flag = 'Y'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Discount_Volume $t(AMOUNT)
  set Year_Discount_Count $t(COUNT)
}

set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'D' and $value and (tid like '010004%' or tid like '01000507%') and settl_flag = 'Y'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
puts "MINIMUM"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and tid like '01000419%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Minimum_Volume $t(AMOUNT)
  set Month_Minimum_Count $t(COUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '01000419%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Minimum_Volume $t(AMOUNT)
  set Quarter_Minimum_Count $t(COUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Minimum_Volume $t(AMOUNT)
  set Year_Minimum_Count $t(COUNT)
}

puts "INTERCHANGE"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and (tid like '%4020000' or tid like '%4020005') and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Interchange_Volume $t(AMOUNT)
  set Month_Interchange_Count $t(COUNT)
}

set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'D' and $value and (tid like '%4020000' or tid like '%4020005') and institution_id = '107' "
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and (tid like '%4020000' or tid like '%4020005') and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Interchange_Volume $t(AMOUNT)
  set Quarter_Interchange_Count $t(COUNT)
}
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'D' and $value and (tid like '%4020000' or tid like '%4020005') and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Interchange_Volume $t(AMOUNT)
  set Year_Interchange_Count $t(COUNT)
}
set date_query ""
set date_query "activity_date_time like '%$name_date_year' and activity_date_time <= '$upper_date'"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'D' and $value and (tid like '%4020000' or tid like '%4020005') and institution_id = '107'"
...
puts "INCOME"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and tid like '010040%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Income_Volume $t(AMOUNT)
  set Month_Income_Count $t(COUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '010040%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Income_Volume $t(AMOUNT)
  set Quarter_Income_Count $t(COUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Income_Volume $t(AMOUNT)
  set Year_Income_Count $t(COUNT)
}

puts "EXPENSE"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and TID_SETTL_METHOD = 'C' and $value and tid like '010041%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Expense_Volume $t(AMOUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '010041%' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Expense_Volume $t(AMOUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Expense_Volume $t(AMOUNT)
}

set query_string "select count(1) as count from acq_entity where entity_level = '70' and parent_entity_id = '447474000000000' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Merchant_Count $t(COUNT)
}

puts "ADJ"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and TID_SETTL_METHOD = 'C' and $value and tid like '01000801' and institution_id = '107' and activity_date_time <= '$upper_date'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Sales_Adj_Volume $t(AMOUNT)
  set Month_Sales_Adj_Count $t(COUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '01000801' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Sales_Adj_Volume $t(AMOUNT)
  set Quarter_Sales_Adj_Count $t(COUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Sales_Adj_Volume $t(AMOUNT)
  set Year_Sales_Adj_Count $t(COUNT)
}

puts "CREDIT"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where activity_date_time like '%$today_date' and TID_SETTL_METHOD = 'C' and $value and tid like '01000802' and institution_id = '107' and activity_date_time <= '$upper_date'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Month_Credit_Adj_Volume $t(AMOUNT)
  set Month_Credit_Adj_Count $t(COUNT)
}

set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count from mas_trans_log where $date_query and TID_SETTL_METHOD = 'C' and $value and tid like '01000802' and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Quarter_Credit_Adj_Volume $t(AMOUNT)
  set Quarter_Credit_Adj_Count $t(COUNT)
}
...
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  set Year_Credit_Adj_Volume $t(AMOUNT)
  set Year_Credit_Adj_Count $t(COUNT)
}
...
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count,TID_SETTL_METHOD from mas_trans_log where activity_date_time like '%$today_date' and $value and tid in ('010003015101','010003005202') and institution_id = '107' and activity_date_time <= '$upper_date' group by TID_SETTL_METHOD"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count ,TID_SETTL_METHOD from mas_trans_log where $date_query and $value and tid in ('010003015101','010003005202') and institution_id = '107' group by TID_SETTL_METHOD"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  if {$t(TID_SETTL_METHOD) == "D"} {
...
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count,TID_SETTL_METHOD from mas_trans_log where activity_date_time like '%$today_date' and $value and tid like '010003005301' and institution_id = '107' and activity_date_time <= '$upper_date' group by TID_SETTL_METHOD"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  if {$t(TID_SETTL_METHOD) == "D"} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select sum(AMT_ORIGINAL) as amount, count(1) as count,TID_SETTL_METHOD from mas_trans_log where $date_query and $value and tid like '010003005301' and institution_id = '107' group by TID_SETTL_METHOD"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  if {$t(TID_SETTL_METHOD) == "D"} {
...
proc Interchange {value} {
 ...
 global year_date name_date_month name_date_year month_date name_date collist1 rightnow cur_local_time CUR_SET_TIME cur_file
  ...
  while {[orafetch $fetch_cursor -dataarray v -indexbyname] != 1403} {
    ...
    set query_string "select MTL.TID_SETTL_METHOD, MTL.mas_code, sum(percent_amt) as percent,MTL.tid,MTL.percent_rate,MTL.per_item_amt,MTL.card_scheme, sum(MTL.amt_original) as amount, count(1) as count, MC.mas_desc from mas_trans_log MTL,mas_code MC where MTL.activity_date_time like '%$today_date' and activity_date_time <= '$upper_date' and MC.mas_code = '$v(MAS_CODE)' and MC.mas_code = MTL.mas_code and (MTL.tid = '010004020000' or MTL.tid = '010004020005') and $value  and institution_id = '107' group by MTL.tid,MTL.card_scheme,MTL.percent_rate,MTL.per_item_amt,MC.mas_desc,MTL.mas_code,MTL.TID_SETTL_METHOD order by MTL.card_scheme,MTL.MAS_CODE"
...
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS <> 'A' and (entity_id not in (select entity_id from mas_trans_log where tid like '010003%' and activity_date_time like '%$today_date' and activity_date_time <= '$upper_date')) and institution_id = '107'"
orasql $test_cursor1 $query_string
puts $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS <> 'A' and (entity_id not in (select entity_id from mas_trans_log where tid like '010003%' and $date_query and activity_date_time <= '$upper_date')) and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "activity_date_time like '%$name_date_year' and activity_date_time <= '$upper_date'"
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS <> 'A' and (entity_id not in (select entity_id from mas_trans_log where tid like '010003%' and $date_query)) and institution_id = '107'"
puts "$query_string 1"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS = 'A' and entity_id in (select entity_id from mas_trans_log where tid like '010003%' and activity_date_time like '%$today_date' and activity_date_time <= '$upper_date') and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "[find_quarter $date_query $month_date]"
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS = 'A' and entity_id in (select entity_id from mas_trans_log where tid like '010003%' and $date_query and activity_date_time <= '$upper_date') and institution_id = '107'"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
...
set date_query ""
set date_query "activity_date_time like '%$name_date_year' and activity_date_time <= '$upper_date'"
set query_string "select count(1) as count from acq_entity where ENTITY_STATUS = 'A' and entity_id in (select entity_id from mas_trans_log where $date_query and tid like '010003%' and activity_date_time <= '$upper_date') and institution_id = '107'"
puts "$query_string 1"
orasql $test_cursor1 $query_string
if {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
