...
set query_string "select unique entity_id from mas_trans_log where DATE_TO_SETTLE like '%$fdate' and institution_id = '107'"
#puts $query_string
...
set cur_file_name "./UPLOAD/107.REPORT.DETAIL.$CUR_JULIAN_DATEX.$filedate.001.csv"
set file_name "107.REPORT.DETAIL.$CUR_JULIAN_DATEX.$filedate.001.csv"
...
while {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  #puts $t(ENTITY_ID)
  set query_string "select * from mas_trans_log where PRICED_DATE_TIME like '$date'  and ENTITY_ID = '$t(ENTITY_ID)' and institution_id = '107' and settl_flag = 'Y'"
...
#(DATE_TO_SETTLE = '23-MAY-07' or activity_date_time = '23-MAY-07') and date_to_settle <> '31-MAY-07' 
 #set query_string "select * from mas_trans_log where (DATE_TO_SETTLE like '$date' or (ACTIVITY_DATE_TIME like '$date' and ENTITY_ID = '$t(ENTITY_ID)' and institution_id = '107' and settl_flag = 'Y'"
 set query_string "select * from mas_trans_log where DATE_TO_SETTLE like '$date' and ENTITY_ID = '$t(ENTITY_ID)' and institution_id = '107' and settl_flag = 'Y'"
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray s -indexbyname] != 1403} {
      switch -- $s(TID) {
        010003015101 {
  ...
  #puts $t(ENTITY_ID)
  set query_string "select * from mas_trans_log where DATE_TO_SETTLE < '$tomorrow' and DATE_TO_SETTLE >= '01-$fdate' and ENTITY_ID = '$t(ENTITY_ID)' and institution_id = '107'  and settl_flag = 'Y'"
  #puts $query_string
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray s -indexbyname] != 1403} {
      switch -- $s(TID) {
...
set query_string "select * from ACCT_ACCUM_DET where PAYMENT_PROC_DT like '%$date' and institution_id = '107'"
orasql $test_cursor1 $query_string
set collist1 [oracols $test_cursor1]
set ACH_AMOUNT 0
set ACH_COUNT 0
...
set query_string "select * from ACCT_ACCUM_DET where PAYMENT_PROC_DT like '%$fdate' and PAYMENT_PROC_DT <= '$tomorrow' and institution_id = '107'"
orasql $test_cursor1 $query_string
set collist1 [oracols $test_cursor1]
...
while {[orafetch $test_cursor1 -dataarray t -indexbyname] != 1403} {
  ...
  set TODAY_RESERVE 0
  set query_string "select sum(amt_original) as total from mas_trans_log where date_to_settle like '$date' and tid like '01000705%' and institution_id = '107'"
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray s -indexbyname] != 1403} {
  ...
  set query_string "select sum(amt_original) as total from mas_trans_log where tid like '01000705%' and institution_id = '107' and activity_date_time < '$tomorrow'"
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray s -indexbyname] != 1403} {
    set TOTAL_RESERVE $s(TOTAL)
  }
  set query_string "select sum(amt_original) as total from mas_trans_log where date_to_settle < '$date' and activity_date_time < '$tomorrow' and tid like '01000705%' and institution_id = '107'"
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray s -indexbyname] != 1403} {
    set RESERVE $s(TOTAL)
  }
  ...
  set query_string "select tid_settl_method,card_scheme,sum(amt_original) as amt_original, count(1) as count from mas_trans_log where DATE_TO_SETTLE > '$yesterday' and activity_date_time < '$date' and tid = '010003005101' and institution_id = '107' group by tid_settl_method,card_scheme"
  ...
  set GRAND_DISCOUNT 0
  set query_string "select tid_settl_method,card_scheme,sum(amt_original) as amt_original, count(1) as count from mas_trans_log where DATE_TO_SETTLE > '$date'  and activity_date_time < '$tomorrow' and tid = '010003005101' and institution_id = '107' group by tid_settl_method,card_scheme"
  puts $query_string
  orasql $fetch_cursor $query_string
  while {[orafetch $fetch_cursor -dataarray w -indexbyname] != 1403} {
    if {$w(TID_SETTL_METHOD) == "C"} {
  ...
  set REJECT_COUNT 0
  set query_string "select * from ep_event_log where EMS_ITEM_TYPE = 'CR1' and EVENT_STATUS = 'NEW' and EVENT_LOG_DATE = '$date' and institution_id = '107'"
