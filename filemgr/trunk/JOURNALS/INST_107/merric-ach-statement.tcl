...
### SYANG ---12-12-2007
     set query_string " select unique entity_id, PAYMENT_SEQ_NBR,
      ...
      set cur_file_name    "./UPLOAD/107.REPORT.ACH.$CUR_JULIAN_DATEX.$filedate.001.csv"
      #set cur_file_name    "../../../../../clearing/filemgr/JOURNALS/INST_107/UPLOAD/107.REPORT.ACH.$CUR_JULIAN_DATEX.$filedate.001.csv"
      #set cur_file_name    "./LOGS/107.REPORT.ACH.$CUR_JULIAN_DATEX.$filedate.001.csv"
      set file_name        "107.REPORT.ACH.$CUR_JULIAN_DATEX.$filedate.001.csv"
