...
if {$argc == 2 } {
	...
	if { $short_month == "DEC" } {
		set short_year        [clock format [clock scan "+0 year"] -format %y]                  ;# fall into previous year
	...
	set institution_id_var [string trim [lindex $argv 0]]
	set date [clock format [clock scan "-1 month"] -format "%d-%b-%y"]
...
puts $cur_file "DISCOUNT settled between '$discount_start_settle_date' and  '$discount_end_settle_date' exclusive"
puts $cur_file "INTERCHANGE calculated between '$interchange_start_gl_date' and '$interchange_end_gl_date' exclusive"
puts $cur_file "CHARGEBACK occured between '$chargeback_gl_start_date' and '$chargeback_gl_end_date' exclusive"
puts  "DISCOUNT settled between '$discount_start_settle_date' and  '$discount_end_settle_date' exclusive"
puts  "INTERCHANGE calculated between '$interchange_start_gl_date' and '$interchange_end_gl_date' exclusive"
puts  "chargeback occured between '$chargeback_gl_start_date' and '$chargeback_gl_end_date' exclusive"
