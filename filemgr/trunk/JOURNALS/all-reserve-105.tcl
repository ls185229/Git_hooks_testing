...
#$Id: all-reserve-105.tcl 4213 2017-06-26 14:36:17Z bjones $
...
if {$mode == "TEST"} {
	...
	set file_name "ROLLUP.REPORT.RESERVE.105.$CUR_JULIAN_DATEX.$filedate.001.csv"
}
...
if {$mode == "TEST"} {
	...
	exec uuencode $cur_file_name $file_name | mailx -r clearing@jetpay.com -s $file_name reports-clearing@jetpay.com risk@jetpay.com  
}
