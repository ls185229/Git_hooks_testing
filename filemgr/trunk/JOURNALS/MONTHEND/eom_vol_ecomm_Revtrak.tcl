...
#$Id: eom_vol_ecomm_Revtrak.tcl 1880 2012-11-06 17:30:41Z ajohn $
...
proc do_report {inst} {
    ...
    set ent_to_auth_qry "select institution_id, entity_id, mid
                    ...
                    and SUBSTR(entity_id,1,6) = '440339'
                    order by entity_id"
    ...
    set filename "EOM.Volume.Revtrak.ecomm.$filedate.csv"
    set cur_file [open "$filename" w]

    
    puts $cur_file "END OF MONTH Revtrak E-Commerce Sales\n\n\n"
