...
################################################################################
# $Id: check_visa_log_4_err_121.sh 3420 2015-09-11 20:05:17Z bjones $
# $Rev: 3420 $
################################################################################
#
# File Name:  check_visa_log_4_err_121.sh
#
# Description:  This script initiates a check for successful BASE2 file uploads 
#               to Visa for institution 121.
#              
...
if recv_log_file_ftp.exp | tee -a $locpth/LOG/log_chk.log; then
	print "Script chk_log.tcl completed successfully" | tee -a $locpth/LOG/log_chk.log
	if check_log_for_error.tcl INST_121 | tee -a $locpth/LOG/log_chk.log; then
