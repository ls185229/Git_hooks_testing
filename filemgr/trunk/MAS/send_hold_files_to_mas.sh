...
# $Id: send_hold_files_to_mas.sh 3819 2016-07-05 16:54:54Z skumar $
...
export SCRIPT_DESCRIPTION="Send hold files to MAS shell"
...
# MANDATORY
# set these variables
SCRIPT_TO_RUN="./send_hold_files_to_mas.tcl $SCRIPT_ARGUMENTS"
SCRIPT_TO_RUN_DESCRIPTION="Send hold files to MAS"
