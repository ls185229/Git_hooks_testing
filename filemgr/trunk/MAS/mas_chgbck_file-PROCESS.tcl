...
# $Id: mas_chgbck_file-PROCESS.tcl 3577 2015-11-13 18:15:11Z bjones $
...
set get_ent "
    ...
    --and event_status in ('NEW', 'NOTIFY', 'PROCESS')
    and event_status in ('PROCESS')
    "
puts "query $get_ent"
