...
################################################################################
#
# File Name:  send_btchhdr_clr2mas.tcl
#
# Description:  This program sends a MAS batch header file to MAS for the 
#               institution.
#              
...
catch {set y [exec find $env(PWD)/MAS_FILES -mtime 0 | grep $inst_id.BTCHHEDR.01*]} result 

if {$y == ""} {
	exec echo "NO FILE FOUND" | mailx -r clearing@jetpay.com -s "PROD: MAS: RECYCLING file not found in MAS folder" clearing@jetpay.com 
