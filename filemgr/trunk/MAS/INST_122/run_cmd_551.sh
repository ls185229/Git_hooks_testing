...
################################################################################
#
# File Name:  run_cmd_551.sh
#
# Description:  This script initiates the scheduling of MAS command 551 for
#               MegaCmd for 107-110-109-102 W/ Def DT.
#              
# Shell Arguments: None.
#
# Script Arguments:  cmdno = Command number.  Required.
...
if $locpth/sch_cmd.tcl $inst_id $cmdno >> $locpth/LOG/cmd.log; then 
