...
################################################################################
#
# File Name:  sch_cmd.tcl
#
# Description:  This script schedules various MAS processing commands.
#              
# Script Arguments:  cyl = ACH cycle.  Required.
#					 inst_id = Institution ID.  Required.
#					 tsk_nbr = Task (i.e., Command) number.  Required.
#
# Output:  None.
#
# Return:   0 = Success
...
#Declaring all the date format required
...
#Declaring a switch to remove zero from infront of time variable to avoid octal format.
switch $r_hr {
    "01" 	{set t_hr 1}
    "02" 	{set r_hr 2}
    "03" 	{set r_hr 3}
