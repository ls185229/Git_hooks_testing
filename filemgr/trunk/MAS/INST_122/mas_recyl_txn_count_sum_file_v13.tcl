...
#
# Description:  This program generates a MAS recycling file for the institution.
#              
...
#                             Required.
#
# Output:  MAS recycling file for the institution.
#
# Return:   0 = Success
#          !0 = Exit with errors
#
...
set get_mids "select mid from MERCHANT_FEE_FLAGS where STATUS = 'A' and TRANSACTION_RECYCLING = 'Y' and institution_id = '$inst_id'"
...
if {$mid_list == ""} {
	puts "No merchants found with TRANSACTION_RECYCLING = 'Y'."
	exec rm $outfile
	exit 0
} else {
	puts $mid_list
