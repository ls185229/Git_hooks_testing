...
################################################################################
#
# File Name:  mas_batchheader_txn_count_sum_file_v13.tcl
#
# Description:  This program initiations the generation of a MAS batch header
#               transaction count summary file for the institution.
#              
...
#                             Required.
#
# Output:  MAS batch header transaction count summary file for the 
#          institution.
#
# Return:   0 = Success
#          !0 = Exit with errors
...
set get_mids "select mid from MERCHANT_FEE_FLAGS where STATUS = 'A' and BATCH_HEADER = 'Y' and institution_id = '$inst_id'"
