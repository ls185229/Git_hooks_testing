...
################################################################################
# $Id: run_all_send_mas_files_to_mas_eom.sh 4583 2018-05-25 15:57:32Z bjones $
# $Rev: 4583 $
################################################################################
#
# File Name:  run_all_send_mas_files_to_mas_eom.sh
#
# Description:  This script initiates movement of individual MAS files to MAS
#               for processing at month end.
#
...
# MANDATORY
# set these variables
SCRIPT_TO_RUN="./send_mas_files_to_mas_eom.sh"
...
for tf in /clearing/filemgr/MAS/MAS_FILES/1*;
    do sleep 10;
done
...
if [ -f $tf ]; then
    ./run_all_send_mas_files_to_mas_eom.sh
fi
