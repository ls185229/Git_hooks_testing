...
# $Id: send_mas_files_to_mas.sh 4422 2017-11-13 17:23:28Z skumar $
...
if [[ "$2" == "NEXTDAY" ]]
then
    export MAIL_TO_FAILURE=$MAIL_TO
    print "MAIL_TO_FAILURE: $MAIL_TO_FAILURE"
fi
...
# MANDATORY
# set these variables
SCRIPT_TO_RUN="./send_mas_files_to_mas.tcl $SCRIPT_ARGUMENTS"
