...
# $Id: sch_cmd.tcl 3819 2016-07-05 16:54:54Z skumar $
...
proc parse_arguments {} {
    ...
    if { [info exists arguments(--cycle)]  } {
        ...
        set valid_cycles "all 1 2 3 4 5 6 7 8 9"
    ...
    switch $GLOBALS(TASK_NUMBER) {
        ...
        "102"             {
            ...
            if { [ catch {
                ...
                set GLOBALS(CMD_PARAMETERS) "-i$GLOBALS(INST_ID) -c$GLOBALS(CYCLE) -d$GLOBALS(CURRENT_DATE) -t$GLOBALS(CURRENT_TIME) -oN -f$set_acct(SETTL_ROUTING_NBR)"
                } failure] } {
