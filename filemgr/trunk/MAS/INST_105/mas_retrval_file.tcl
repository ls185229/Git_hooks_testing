...
proc pbchnum {} {
global inst_dir bchnum bchnum batch_num_file 
...
set get_ent "select * from ep_event_log where institution_id = '$inst_id' and ems_item_type like 'RR1%' and event_log_date like '$e_date%'"
...
###### Writing Batch Header Or Batch Trailer
	...
	set trlcnt 1
        ...
        set rec(institution_id) $a(SEND_ID)
...
puts "EMS_ITEM_TYPE:	>$a(EMS_ITEM_TYPE)<"
puts "CARD_SCHEME:	>$b(CARD_SCHEME)<"
