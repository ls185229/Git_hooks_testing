...
# $Id: get_clearing_mas_files_full.sh 3510 2015-09-22 21:22:57Z bjones $
...
export SCRIPT_DESCRIPTION="Get clearing MAS files script runner"
...
MAIL_TO_FAILURE="bjones@jetpay.com"
MAIL_TO_NOTIFY="bjones@jetpay.com"
...
# MANDATORY
# set these variables
SCRIPT_TO_RUN="./get_clearing_mas_files.tcl $SCRIPT_ARGUMENTS"
SCRIPT_TO_RUN_DESCRIPTION="Get MAS files produced by clearing"
SCRIPT_LOG_FILE="LOG/MAS.get_clearing_mas_files.log"
...
###    Blocked following section to stop sending failure emails twice
