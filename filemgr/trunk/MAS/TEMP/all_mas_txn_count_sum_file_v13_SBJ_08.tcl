...
# patch to recalc discover data usage 2016/10/31

# $Id: all_mas_txn_count_sum_file_v13.tcl 3900 2016-09-28 22:21:23Z skumar $
...
#source [file join [file dirname $argv0 ] CentralExtendedToEastConversionFileDesc.tcl]
#source [file join [file dirname $argv0 ] CentralExtendedToEastConversionValidate.tcl]
...
set id_var  "$Id: all_mas_txn_count_sum_file_v13.tcl 3900 2016-09-28 22:21:23Z skumar $nihil"
set rev_var "$Rev: 3900 $nihil"
...
foreach midlist $list_of_mid_lists {
    ...
    while {[set loop [orafetch $cursor -dataarray a -indexbyname]] == 0} {
        ...
        if {$chkmid != $a(MID)} {
            ...
            if { $cnt_type == "AU" || $cnt_type == "DISC_DATA" } {
