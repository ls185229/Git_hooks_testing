...
# $Id: fanf_processing.tcl 3016 2015-06-25 19:27:17Z jkruse $
...
set id_var  "$Id: fanf_processing.tcl 3016 2015-06-25 19:27:17Z jkruse $nihil"
...
proc get_curr_cd {f_type midlist} {
    ...
    ###### Loading Visa/MC id as exntity_id into an array with index of MID from the
    # Database
    if { $f_type == "FANF" || $f_type == "FPREPORT" } {
...
if {$cnt_type == "FANF" || $cnt_type == "FPREPORT"} {
