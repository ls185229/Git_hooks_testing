...
REM $Id: fanf_report_queries_full_rpt.sql 3537 2015-10-12 19:04:52Z bjones $
...
exec :inst4_var           := ''
exec :inst5_var           := ''
exec :mth_1               := '01-jan-15'
exec :mth_2               := '01-feb-15'
exec :mth_3               := '01-mar-15'
...
from fanf_history fh right outer join fanf_table_1a ft on fh.table_1_tier = ft.tier and fh.table_1 = 'A'
where 1=1
and
    (fh.table_1 = 'A'
...
from fanf_history fh right outer join fanf_table_1b ft on fh.table_1_tier = ft.tier and fh.table_1 = 'B'
where 1=1
and
    (fh.table_1 = 'B'
    and fh.month_requested
...
from fanf_history fh right outer join fanf_table_2 ft on fh.table_2_tier = ft.tier and fh.table_2 = 'Y'
where 1=1
and
    (fh.table_2 = 'Y'
    and fh.month_requested
