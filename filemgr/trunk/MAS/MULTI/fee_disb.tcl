...
set fname "ARBCREDT"
set ctfname "base2.exp.pd.rp.fc"
set dot "."
set jdate ""
...
array set ARB_ARNS {
24610844051011660067792 299500
}
...
proc write_fdh_record {fd aname} {
	...
	set rec(fdhtransCode) "90"
        ...
        set rec(fdhprocessingDate) "4177"
...
proc write_fddet_record {fd aname} {
	...
	set rec(fd0messageText) " PARB; CARDHOLDER CRED AT REQUEST OF ACQUIRER  "
	set rec(fd0settlementFlag) "0"
	set rec(fd0transIdentifer) $a(fd0transIdentifer)
	set rec(fd0reserved1) "0"
	set rec(fd0centralProcessingDate) "4177"
...
proc write_fdbt_record {fd aname} {
    ...
    upvar $aname a
        ...
        set rec(fdbtprocessingDate) "4177"
...
proc write_fdft_record {fd aname} {
    ...
    upvar $aname a
        ...
        set rec(fdftprocessingDate) "4177"
...
set get_ent " select in_draft_main.src_inst_id,
 ...
 where in_draft_main.trans_seq_nbr = in_draft_baseii.trans_seq_nbr AND
       in_draft_main.arn in ('24610844051011660067792')
...
###### Writing Massage Detail records
    ...
    set mas_tid "010003010102"
    set rec(mas_code) "04ARBCRDT"  
