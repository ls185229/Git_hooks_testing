...
array set ARB_ARNS {
24869542024002300453577	1790
05490481356035500899921	14395
}
...
proc write_fdh_record {fd aname} {
	...
	set rec(fdhtransCode) "90"
        ...
        set rec(fdhprocessingDate) "2243"
...
proc write_fddet_record {fd aname} {
	...
	set rec(fd0centralProcessingDate) "2243"
...
proc write_fdbt_record {fd aname} {
    ...
    upvar $aname a
        ...
        set rec(fdbtprocessingDate) "2243"
...
proc write_fdft_record {fd aname} {
    ...
    upvar $aname a
        ...
        set rec(fdftprocessingDate) "2243"
...
set get_ent " select in_draft_main.src_inst_id,
 ...
 where in_draft_main.trans_seq_nbr = in_draft_baseii.trans_seq_nbr AND
       in_draft_main.arn in ('24869542024002300453577',
'05490481356035500899921')" 
