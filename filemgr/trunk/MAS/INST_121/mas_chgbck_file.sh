...
#
# Description:  This program initiations the generation of a MAS chargeback 
#               file for the institution.
#              
...
$locpth/mas_chgbck_file.tcl `date +%Y%m%d` >> $locpth/LOG/chg_back.log
