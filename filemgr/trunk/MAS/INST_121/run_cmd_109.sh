...
################################################################################
#
# File Name:  run_cmd_109.sh
#
# Description:  This script initiates the scheduling of MAS command 109 for
#               Calculation of Next Settlement Date.
#              
