...
set i 0
if {[llength $y] >=  2} {
exec echo $x | mailx -r clearing@jetpay.com -s "PROD: MAS: Multiple DEBITRAN file found in MAS folder" reports-clearing@jetpay.com clearing@jetpay.com assist@jetpay.com
exit 1
}
