...
################################################################################
#
# File Name:  send_counting_file.tcl
#
# Description:  This script send the institution counting file to MAS.
#              
...
catch {set y [exec find $env(PWD)/UPLOAD -mtime 0 | grep $inst_id.DEBITRAN.01.*]} result 

if {$y == ""} {
exec echo "No files found for today" | mailx -r clearing@jetpay.com -s "PROD: MAS: DEBITRAN file not found in MAS folder" clearing@jetpay.com
