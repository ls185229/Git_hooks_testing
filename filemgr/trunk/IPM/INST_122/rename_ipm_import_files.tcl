...
################################################################################
# $Id: rename_ipm_import_files.tcl 4573 2018-05-18 20:43:39Z bjones $
# $Rev: 4573 $
################################################################################
#
# File Name:  rename_ipm_import_files.tcl
#
# Description:  This program renames incoming MasterCard report files.
#              
...
set dummy ""
set dummy1 ""
set flder "107-MCDailyReports-$curdate"
exec mkdir $flder
...
if {[llength $x] ==  6} {
		foreach file $x {
			...
			set i [expr $i + 1]
                        ...
                        exec echo $x | mailx -r $mailfromlist -s "IPM report file count is not 6" $mailtolist
			exit 1
                }
