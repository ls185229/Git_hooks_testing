...
################################################################################
# $Id: run_ipm_file_xfer.sh 3724 2016-04-05 22:27:58Z millig $
# $Rev: 3724 $
################################################################################
#
# File Name:  run_ipm_file_xfer.sh
#
# Description:  This script downloads incoming MasterCard files from the 
#               Windows box.
#              
