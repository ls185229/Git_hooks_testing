...
set customer "reports-clearing@jetpay.com"
...
######UPDATE WHEN USING FOR NEW INST ##################################################################################
...
exec mutt -a $zipflder -s "$inst_id MC Daily Reports $cdate" Reports-clearing@jetpay.com < body.txt


puts "------EMAIL SENT for $inst_id: $zipflder ------- $logdate"
