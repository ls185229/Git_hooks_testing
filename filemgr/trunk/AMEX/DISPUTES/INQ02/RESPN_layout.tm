...
# $Id: RESPN_layout.tm 2457 2013-10-23 21:45:26Z bjones $
...
namespace eval RESPN {
    ...
    set det_rec(1) {
        ...
        13  DATE_ACTION_TAKEN       8   d   108 115 {}      {}                  {MMDDYYYY}
        ...
        # 3   CM_ACCT_NUMB            renamed from CM_NUMBER
        # 4   CURRENT_CASE_NUMBER     renamed from CASE_NUMBER
        # 5   SE_NUMB                 renamed from SE_NUMBER
        # 6   CM_ACCT_NUMB            renamed from CM_NUMBER
        # 7   CM_NAME1                renamed from CM_NAME
        # 8   CURRENT_CASE_NUMBER     renamed from INQUIRY_CASE_NUMBER
        # 9   CURRENT_ACTION_NUMBER   renamed from INQUIRY_ACTION_NUMBER
        # 11  RESOLUTION_CODE         renamed from INQUIRY_ACTION_RESOLUTION_CODE
