...
global detail_record
   ...
   ## T-1 need to add clause to eliminate CB reversals reason code M10 M11, eg case FR02599
...
global STARS_FILESEQ_NB
   ...
   ## T-1 instead of hardcoding the values, query the database
   ## T-1 that way you will also get the client_area info
   set header ""
