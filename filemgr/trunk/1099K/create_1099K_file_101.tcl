...
#
################################################################################
# $Id: create_1099K_file_101.tcl 4012 2017-01-06 18:13:25Z millig $
# $Rev: 4012 $
# $Author: millig $
################################################################################
...
proc initDB {} {
    ...
    set merchantInfoCur "select distinct institution_id iso_id
          ...
          where contact_role = 'DEF'
            ...
            and ae.entity_id in ('447474200000050',
'447474200000075',
'447474200000080',
'447474200000132',
'447474200000133',
...
'447474400000215',
'447474400000314',
'447474410000134', '447474200000177') 
...
#	  puts "Inst id: $instId, ENTITY: $acctnumbermid, YEAR: $year"
      ...
      if {[orafetch $merchantSumCurHandle -dataarray ds3 -indexbyname] != 1403} {
		 ...
		 set  grossPaymentAmt [expr $grossPaymentAmt + $decemberPayments  ]
                 set  total_payments $grossPaymentAmt
                 set  grossPaymentAmt [expr double(round(100*$total_payments))/100 ] 
    }
