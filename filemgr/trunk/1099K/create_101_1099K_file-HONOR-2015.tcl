...
################################################################################
#
#    File Name - create_1099K INST 107 HONOR BANK for year 2015
#
    ...
    set merchantInfoCur "select distinct ae.institution_id iso_id
          ...
          where contact_role = 'DEF'
            ...
            and (ae.entity_status = 'A'
               or ae.termination_date between to_date('01/01/2015', 'mm/dd/yyyy') and to_date('02/24/2016', 'mm/dd/yyyy'))
...
proc openOutputFile {} {
    ...
    set fileName [format "inst_107_HONOR_1099K_%s.csv"  $createDate]
