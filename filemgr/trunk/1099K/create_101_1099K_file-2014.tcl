...
#
################################################################################
# $Id: create_101_1099K_file-2014.tcl 4012 2017-01-06 18:13:25Z millig $
# $Rev: 4012 $
# $Author: millig $
################################################################################
    ...
    set merchantInfoCur "select distinct institution_id iso_id
          ...
          where contact_role = 'DEF'
            ...
            and (ae.entity_status = 'A'
               or ae.termination_date between to_date('01/01/2014', 'mm/dd/yyyy') and to_date('01/17/2015', 'mm/dd/yyyy'))
...
proc openOutputFile {} {
    ...
    set fileName [format "inst_101_1099K_%s.csv"  $createDate]
