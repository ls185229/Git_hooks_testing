...
#
################################################################################
# $Id: create_1099K_file_101_2.tcl 4012 2017-01-06 18:13:25Z millig $
# $Rev: 4012 $
# $Author: millig $
################################################################################
...
proc initDB {} {
    ...
    set merchantInfoCur "select distinct institution_id iso_id
          ...
          where contact_role = 'DEF'
            ...
            and ae.entity_id in ('447474200000075','447474200000080','447474400000123','447474400000141','447474400000314')
                    ...
                    from (select posting_entity_id
                         ...
                         , nvl(decode(to_char(gl_date, 'mm'), '12', amt_billing * decode(tid_settl_method, 'D', -1, 1), 0), 0) DECPAYMENT
                                        ...
                                        where institution_id = :INST
                                          and posting_entity_id in ('447474200000075','447474200000080','447474400000123','447474400000141','447474400000314') 
