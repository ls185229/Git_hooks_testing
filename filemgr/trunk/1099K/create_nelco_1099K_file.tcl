...
#
################################################################################
# $Id: create_nelco_1099K_file.tcl 4012 2017-01-06 18:13:25Z millig $
# $Rev: 4012 $
# $Author: millig $
################################################################################
...
proc init {argc argv} {
	...
	set creditTids "'010003005101', '010003005202', '010123005102'"
	set institutionIds "'105', '106'"
          ...
          where contact_role = 'DEF'
            and address_role = 'BIL'
             and (ae.entity_status = 'A'
                or ae.termination_date between to_date('01/01/$year', 'mm/dd/yyyy') and to_date('12/31/$year 23:59:59', 'mm/dd/yyyy hh24:mi:ss'))
