#!/usr/bin/env python
'''
$Id: amex_tilr_file.py 4455 2017-12-21 18:32:34Z skumar $
$Rev: 4455 $
...
class AmexTilrClass():
    ...
    def displayDict(self, testDict, data):
        '''
        Name        : displayDict
    ...
    def parseRec(self, testDict, data):
        '''
        Name        : parseRec
        ...
        for key,val in testDict.items():
            ...
            if key == 'other_fee_amount':
                ...
                amt = self.convertAmount(other_amt)
                #print('Amt:', amt)
            elif key == 'seller_id':
    ...
    def parseAmexConfigFile(self, file_name):
        '''
        ...
        with open(file_name) as fp:
            for line in fp:
                ...
                if val == 'Other_Fees_Record':
                    #self.displayDict(data_dict, line)
                    self.parseRec(data_dict, line)
