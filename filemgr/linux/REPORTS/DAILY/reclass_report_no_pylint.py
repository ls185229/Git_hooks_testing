...
'''
$Id: reclass_report.py 4881 2019-08-12 22:03:05Z skumar $
$Rev: 4881 $
...
class ReclassReportClass():
    ...
    def generate_report(self, db_obj, run_date):
        ...
        try:
            sql_query = """
                select distinct ae.INSTITUTION_ID inst_id,
        ...
        """
            ...
            log_msg = 'Start Date: {}'.format(temp_date)
            self.logger.info(log_msg)
            end_date = (temp_date + timedelta(days=1)).strftime('%d-%b-%Y')
            ...
            outFileName = 'reclass_report_{}.csv'.format(run_date)
    ...
    def set_logger_level(self, verbosity_level):
        ...
        """
        try:
            if verbosity_level == 5:             # called with -vvvvv
            ...
            elif verbosity_level == 1:           # called with -v
