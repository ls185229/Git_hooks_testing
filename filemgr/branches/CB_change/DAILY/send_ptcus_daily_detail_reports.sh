...
################################################################################
# $Id: send_ptcus_daily_detail_reports.sh 4054 2017-02-06 23:16:14Z millig $
# $Rev: 4054 $
################################################################################
#
...
init_script()
{
   ...
   log_file=$locpth/LOG/send_ptcus_daily_detail_reports.log
   dd_report_mask=134.Daily_Detail_Report.$run_date*
   echo $dd_report_mask
