...
################################################################################
# $Id: send_ptcus_auth_reports.sh 4054 2017-02-06 23:16:14Z millig $
# $Rev: 4054 $
################################################################################
#
...
init_script()
{
   ...
   log_file=$locpth/LOG/send_ptcus_auth_reports.log
   auth_report_mask=134.Auth_Balancing_Report.$run_date*
...
then
    alert_someone "Auth Balancing report file transfer to B2Billing $0 processing for run date $file_run_date failed."
fi
