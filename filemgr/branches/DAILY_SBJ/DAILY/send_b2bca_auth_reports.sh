...
################################################################################
# $Id: send_b2bca_auth_reports.sh 4217 2017-06-26 17:39:20Z bjones $
# $Rev: 4217 $
################################################################################
#
...
init_script()
{
   ...
   log_file=$locpth/LOG/send_b2bca_auth_reports.log
   auth_report_mask=130.Auth_Balancing_Report.$run_date*
...
#-- Upload to B2Billig
#--
echo "Attempting to upload Auth Balancing report to B2Billig at `date +%H`:`date +%M`:`date +%S`"
